...
@section('title', 'Create Guide Page')
@section('header', 'Create Guide Page')
        ...
        <form method="POST" action="{{ route('admin.guide.store') }}">
            ...
            <div class="space-y-6">
                ...
                <div>
                    ...
                    <input type="text" id="category" name="category" value="{{ old('category') }}" placeholder="e.g., Getting Started, FAQ"
                           class="w-full px-4 py-2.5 border border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-blue-500">
                ...
                <div>
                    ...
                    <textarea id="content" name="content" rows="12" required
                              class="w-full px-4 py-2.5 border border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-blue-500 font-mono text-sm">{{ old('content') }}</textarea>
                ...
                <div>
                    ...
                    <textarea id="meta_description" name="meta_description" rows="2"
                              class="w-full px-4 py-2.5 border border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-blue-500">{{ old('meta_description') }}</textarea>
                </div>

                <div>
                    <label for="meta_keywords" class="block text-sm font-medium text-gray-700 mb-1">Meta Keywords (comma separated)</label>
            ...
            <div class="flex items-center justify-end space-x-3 mt-8">
                ...
                <button type="submit" class="px-6 py-2 bg-blue-600 text-white rounded-xl font-medium hover:bg-blue-700 transition-colors">Create Page</button>
            </div>
        </form>
    </div>
</div>
