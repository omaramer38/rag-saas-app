    ...
    <div class="bg-white rounded-2xl border border-gray-100 p-6">
        <form method="POST" action="{{ route('admin.plans.store') }}">
            ...
            <div class="space-y-6">
                ...
                <div>
                    ...
                    <textarea id="description" name="description" rows="3"
                              class="w-full px-4 py-2.5 border border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-blue-500">{{ old('description') }}</textarea>
                ...
                <div class="grid grid-cols-2 gap-4">
                    ...
                    <div>
                        ...
                        <input type="number" id="duration_days" name="duration_days" value="{{ old('duration_days', 30) }}" required min="1"
                               class="w-full px-4 py-2.5 border border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-blue-500">
                ...
                <div>
                    ...
                    <textarea id="features" name="features" rows="4" placeholder="1 PDF Upload&#10;100 Chat Messages&#10;Email Support"
                              class="w-full px-4 py-2.5 border border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-blue-500">{{ old('features') }}</textarea>
            ...
            <div class="flex items-center justify-end space-x-3 mt-8">
                ...
                <button type="submit" class="px-6 py-2 bg-blue-600 text-white rounded-xl font-medium hover:bg-blue-700 transition-colors">Create Plan</button>
            </div>
        </form>
    </div>
</div>
